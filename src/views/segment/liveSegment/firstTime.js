...
const FirstTime = () => {
  ...
  const data = {
    ...
    datasets: [
      {
        label: "First time app launched user - Live segment",
  ...
  return (
    <div className="content">
        ...
        <div className="col-12 col-md-8 d-flex align-items-center mb-2 mb-md-0">
          ...
          <>
            ...
            <h2 className="mb-0 me-3 ms-md-4 d-none d-md-block ml-4">
              First Time App Launched User - Live Segment
            </h2>

            {/* h5 visible below md */}
            <h4 className="mb-0 me-3 ms-3 d-block d-md-none ml-4">
              First Time App Launched User - Live Segment
            </h4>
          </>

          <Badge color="success" className="align-items-center ml-2 mt-2">
            Live segment
          </Badge>
        </div>
      ...
      <Card className="mt-3">
        ...
        <hr color="#ccc" />
        <CardBody>
          <h4>Live user Actions</h4>
          <div
            className="p-3"
            style={{ border: "1px solid #ccc", borderRadius: "12px" }}
          >
            <Card className="p-3">
              {/* This ensures the badge only takes the space it needs */}
              <Badge
                color="default"
                className="custom-badge d-inline-block mb-2 col-1"
              >
                App Launch
              </Badge>

              {/* Flex container for smaller badges */}
              <div className="d-flex gap-2 flex-wrap">
                <Badge color="default" className="custom-badge d-inline-block">
                  Where
                </Badge>
                <Badge color="default" className="custom-badge d-inline-block">
                  First Time
